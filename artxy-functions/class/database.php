...
class Database{
    ...
    private $db_name = "artxy"; //database name
    ...
    // Function to automatically connect to database when the class was called
    ...
    public function dbConnect(){
        if(!$this->con){
			$this->mysqli = new mysqli($this->db_host,$this->db_user,$this->db_pass,$this->db_name);  // mysql_connect() with variables defined at the start of Database class
